...
public class PulsarConsumerDialog extends DialogWrapper {
    ...
    public PulsarConsumerDialog(@Nullable Project project) {
        super(project);
        setTitle("Creates new pulsar consumer");
        _project = project;
        init();
    }
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        label3 = new JLabel();
        textField3 = new HintTextField(" subscription name ");
        label4 = new JLabel();
        textField4 = new HintTextField(" the name of the topic ");
        ...
        //---- label1 ----
        label1.setText("Name");
        label1.setMaximumSize(new Dimension(79, 16));
        label1.setMinimumSize(new Dimension(79, 16));
        label1.setPreferredSize(new Dimension(79, 16));
    ...
    protected ValidationInfo doValidate() {
        ...
        if (StringUtils.isBlank(textField3.getText().trim())) {
            return new ValidationInfo("Subscription name cannot be empty", textField3);
        }
        if (StringUtils.isBlank(textField4.getText().trim())) {
            return new ValidationInfo("Topic name cannot be empty", textField4);
        }
